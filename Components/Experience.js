  ...
  return (
    <div id="experience" className="mt-28  text-white">
      ...
      <div className="flex flex-col lg:flex-row lg:mx-28 mt-14">
        <div className="w-72 lg:w-2/5 overflow-x-auto mr-8  flex flex-row lg:flex-col h-auto ">
          {Object.keys(Data).map((element, index) => {
            if (element === title) {
              return (
                <div
                  className="border-l-4 w-72 bg-gray-700 pr-10 lg:mr-0 text-yellow-100 font-bold bg-opacity-60 border-yellow-100 cursor-pointer py-3 pl-3"
            ...
            return (
              <div
                className="border-l-4 pr-10 w-72 lg:mr-0 border-yellow-100 cursor-pointer py-3 pl-3"
                onClick={() => change(index)}
                key={index}
              >
                {element}
        ...
        <div className="ml-1 w-full lg:mt-0 mt-10">
